...
module.exports = {
  ...
  KAFKA_CONSUMER_CLIENT_CERT: process.env.KAFKA_CLIENT_CERT,
  KAFKA_CONSUMER_CLIENT_CERT_KEY: process.env.KAFKA_CLIENT_CERT_KEY,

  // Kafka producer config
  KAFKA_PRODUCER_URL: process.env.KAFKA_URL || 'localhost:9092',
  // below are used for secure Kafka connection, they are optional
  // for the local Kafka, they are not needed
  KAFKA_PRODUCER_CLIENT_CERT: process.env.KAFKA_CLIENT_CERT,
  KAFKA_PRODUCER_CLIENT_CERT_KEY: process.env.KAFKA_CLIENT_CERT_KEY,
  ...
  PRODUCER_TOPIC: process.env.PRODUCER_TOPIC || 'test.email',
